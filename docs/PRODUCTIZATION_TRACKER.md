...
| PZ-003 | Week 1 | Validate migration rollout for readiness tables | `blocked` | `docs/PRODUCTIZATION_EVIDENCE_INDEX.md` (Week 1; local Postgres unavailable) | owner |
| PZ-004 | Week 2 | Stage run: retrain -> forecast -> accuracy -> promotion | `blocked` | `docs/PRODUCTIZATION_EVIDENCE_INDEX.md` (Week 2; test-depth complete, staging run pending) | owner |

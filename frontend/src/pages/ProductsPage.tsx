        ...
        <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-shelf-foreground/60">Manage SKU metadata and inventory status</p>
                </div>
                ...
                <div className="card border border-white/40 shadow-sm">
                    <div className="mb-4 flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-shelf-foreground/55">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <label className="inline-flex items-center gap-2 text-sm text-shelf-foreground/70">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
                <div className="card-compact flex items-center gap-3 lg:col-span-3">
                    ...
                    <input
                        ...
                        className="w-full border-none bg-transparent text-sm text-shelf-foreground placeholder:text-shelf-foreground/40 focus:outline-none"
                        value={searchTerm}
                        onChange={(event) => setSearchTerm(event.target.value)}
                    />
                </div>
                <div className="card-compact flex items-center justify-between">
                    <span className="text-xs font-medium text-shelf-foreground/60">Visible SKUs</span>
                    <span className="text-lg font-bold text-shelf-primary">{filteredProducts.length}</span>
                </div>
            </div>
                ...
                <div className="card overflow-hidden border border-white/40 p-0 shadow-sm">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            <thead className="bg-shelf-secondary/5 text-xs font-semibold uppercase tracking-wider text-shelf-foreground/70">
                                <tr>
                            ...
                            <tbody className="divide-y divide-shelf-foreground/5">
                                {filteredProducts.map((product) => (
                                    <tr
                                        ...
                                        className="group cursor-pointer transition-colors hover:bg-shelf-primary/5"
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-shelf-secondary/10 text-shelf-primary">
                                                    <Package className="h-5 w-5" />
                                                </div>
                                                <div>
                                                    <div className="font-medium text-shelf-foreground">{product.name}</div>
                                                    <div className="font-mono text-xs text-shelf-foreground/50">{product.sku}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-sm text-shelf-foreground/70">{product.brand ?? '—'}</td>
                                        <td className="px-6 py-4">
